...
<?php if ($all_done): ?>
<div class="alert alert-success">
  🎉 <strong>Félicitations !</strong> Tu as terminé tous les exercices du lab. Tu comprends maintenant les 3 types de XSS et leur impact réel.
</div>
<?php elseif ($solved_count > 0): ?>
<div class="alert alert-info">
  Tu as complété <?= $solved_count ?>/4 exercices. Reviens terminer les autres pour avoir une vue complète des attaques XSS !
</div>
<?php endif; ?>
...
<div class="card">
  ...
  <div style="overflow-x:auto;">
    <table style="width:100%; border-collapse:collapse; font-size:0.85em;">
      ...
      <tbody>
        <tr><td style="padding:10px; border-bottom:1px solid var(--border);"><code>htmlspecialchars()</code></td><td style="padding:10px; border-bottom:1px solid var(--border);">Reflected & Stored XSS</td><td style="padding:10px; border-bottom:1px solid var(--border);"><span class="tag tag-danger">CRITIQUE</span></td></tr>
        <tr><td style="padding:10px; border-bottom:1px solid var(--border);"><code>textContent</code> vs <code>innerHTML</code></td><td style="padding:10px; border-bottom:1px solid var(--border);">DOM-Based XSS</td><td style="padding:10px; border-bottom:1px solid var(--border);"><span class="tag tag-danger">CRITIQUE</span></td></tr>
        <tr><td style="padding:10px; border-bottom:1px solid var(--border);">Content-Security-Policy</td><td style="padding:10px; border-bottom:1px solid var(--border);">Tous types (couche sup.)</td><td style="padding:10px; border-bottom:1px solid var(--border);"><span class="tag tag-warn">ÉLEVÉ</span></td></tr>
        <tr><td style="padding:10px; border-bottom:1px solid var(--border);">Cookie <code>HttpOnly</code></td><td style="padding:10px; border-bottom:1px solid var(--border);">Vol de session</td><td style="padding:10px; border-bottom:1px solid var(--border);"><span class="tag tag-danger">CRITIQUE</span></td></tr>
        <tr><td style="padding:10px; border-bottom:1px solid var(--border);">Validation des entrées</td><td style="padding:10px; border-bottom:1px solid var(--border);">Réduction de surface</td><td style="padding:10px; border-bottom:1px solid var(--border);"><span class="tag tag-warn">ÉLEVÉ</span></td></tr>
      </tbody>
    </table>
  </div>
</div>
